...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(description='Sort a list of integers using my special sort, list is provided via input text file')
  ...
  if args.time:
    ...
    times = timeit.Timer( partial(my_sort, int_list) ).repeat(1, 1)
    ...
    int_list, comps = my_sort(int_list)
