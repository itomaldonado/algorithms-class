...
def dfs(max_vertex, graph=[], start=0):
  """
  DFS implementation
  """
  VISITED = set()
...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(description='DFS implementation')
  ...
  # Finally, get DFS
  start = time.clock()
  DFS = dfs(max_vertex=max_vertex, graph=graph, start=0)
  log("DFS calculated Time: {0}".format( (time.clock() - start) ))
